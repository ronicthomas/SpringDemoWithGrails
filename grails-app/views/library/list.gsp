			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="address" title="${message(code: 'library.address.label', default: 'Address')}" />
				...
				<g:each in="${libraryInstanceList}" status="i" var="libraryInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${libraryInstance.id}">${fieldValue(bean: libraryInstance, field: "address")}</g:link></td>
